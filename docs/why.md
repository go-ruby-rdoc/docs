...
`go-ruby-rdoc/rdoc` reimplements Ruby's `rdoc` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-rdoc/rdoc` directly, with no Ruby runtime;
