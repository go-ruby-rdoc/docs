# go-ruby-rdoc documentation

**Pure-Go, MRI-4.0.5-faithful Ruby rdoc (no cgo)**

`go-ruby-rdoc/rdoc` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rdoc`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-rdoc/rdoc`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rdoc`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-rdoc/rdoc
```
...
| Repo | What it is |
| --- | --- |
| [`rdoc`](https://github.com/go-ruby-rdoc/rdoc) | the library — Ruby's `rdoc` in pure Go |
| [`docs`](https://github.com/go-ruby-rdoc/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rdoc.github.io`](https://github.com/go-ruby-rdoc/go-ruby-rdoc.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rdoc/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rdoc/rdoc](https://github.com/go-ruby-rdoc/rdoc).
