...
The public API lives at the module root (`github.com/go-ruby-rdoc/rdoc`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rdoc`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-rdoc/rdoc](https://pkg.go.dev/github.com/go-ruby-rdoc/rdoc)**

The module's [README](https://github.com/go-ruby-rdoc/rdoc#readme) carries worked
