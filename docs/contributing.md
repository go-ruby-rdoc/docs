...
Contributions are welcome. `go-ruby-rdoc/rdoc` is built to a small set of
...
The library is in [`github.com/go-ruby-rdoc/rdoc`](https://github.com/go-ruby-rdoc/rdoc).
This documentation site is in [`github.com/go-ruby-rdoc/docs`](https://github.com/go-ruby-rdoc/docs).
